...
#define above_sea_lvl         125                                                           // sensor location above sea lvl in meters
#define MY_RADIO_NRF24                                                                      // transport w ramach biblioteki mysensors
#define MY_DEBUG                                                                            // Enable debug prints
#define MY_NODE_ID            6                                                             // <--- !!! SET NODE ADDRESS HERE !!!
...
unsigned int weight = 4;                                                                    // Max 64 min 1, unsigned int = 0-65535 max from adc 1023 *64 = 65472
float avg_mesure = 0.0;                                                                     //
